...
function getPosition(event: ethereum.Event, tokenId: BigInt): Position | null {
  ...
  if (position === null) {
    try {
      ...
      log.warning('Error getting position for tokenId {}: {}', [tokenId.toString(), e.toString()])
      return null
    }
  }
...
function updateFeeVars(position: Position, event: ethereum.Event, tokenId: BigInt): Position {
  try {
    ...
    log.warning('Error updating fee vars for position {}: {}', [position.id, e.toString()])
  }
  return position
}
...
function savePositionSnapshot(position: Position, event: ethereum.Event): void {
  try {
    ...
    log.warning('Error saving position snapshot: {}', [e.toString()])
  }
}
...
export function handleIncreaseLiquidity(event: IncreaseLiquidity): void {
  ...
  try {
    ...
    log.warning('Error processing IncreaseLiquidity for position {}: {}', [position.id, e.toString()])
  }
}
...
export function handleDecreaseLiquidity(event: DecreaseLiquidity): void {
  ...
  try {
    ...
    log.warning('Error processing DecreaseLiquidity for position {}: {}', [position.id, e.toString()])
  }
}
...
export function handleCollect(event: Collect): void {
  ...
  try {
    ...
    log.warning('Error processing Collect for position {}: {}', [position.id, e.toString()])
  }
}
